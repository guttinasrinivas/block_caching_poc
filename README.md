...
This is original work, based on various amazing bits of software by some incredibly smart people. All credits to them where due. Please refer to the individual licenses of each software subsystem/library used for individual detailed licensing terms.  
...
**Hash Tables**  
This is the best solution - O(1). Constant time and memory complexity. Almost constant memory complexity.  
